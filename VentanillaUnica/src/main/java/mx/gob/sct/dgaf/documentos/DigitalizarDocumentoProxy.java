...
public class DigitalizarDocumentoProxy implements mx.gob.sct.dgaf.documentos.DigitalizarDocumento {
  private String _endpoint = null;
  private mx.gob.sct.dgaf.documentos.DigitalizarDocumento digitalizarDocumento = null;
  ...
  private void _initDigitalizarDocumentoProxy() {
    try {
      digitalizarDocumento = (new mx.gob.sct.dgaf.documentos.DigitalizarDocumentoServiceLocator()).getDigitalizarDocumentoSoapPort();
  ...
  public mx.gob.sct.dgaf.documentos.DigitalizarDocumento getDigitalizarDocumento() {
    if (digitalizarDocumento == null)
      _initDigitalizarDocumentoProxy();
